 ...
 */
final class Version20241205145313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE grupo (id INT AUTO_INCREMENT NOT NULL, cliente_id INT DEFAULT NULL, reserva_id INT NOT NULL, INDEX IDX_8C0E9BD3DE734E51 (cliente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE grupo ADD CONSTRAINT FK_8C0E9BD3DE734E51 FOREIGN KEY (cliente_id) REFERENCES cliente (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE grupo DROP FOREIGN KEY FK_8C0E9BD3DE734E51');
