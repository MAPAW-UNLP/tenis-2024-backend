 ...
 */
final class Version20241121012006 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pagos (id INT AUTO_INCREMENT NOT NULL, profesor_id INT DEFAULT NULL, proveedor_id INT DEFAULT NULL, id_persona INT DEFAULT NULL, id_tipo_clase INT DEFAULT NULL, monto DOUBLE PRECISION NOT NULL, fecha DATE NOT NULL, hora TIME NOT NULL, motivo VARCHAR(255) NOT NULL, descripcion VARCHAR(100) DEFAULT NULL, cantidad INT DEFAULT NULL, INDEX IDX_DA9B0DFFE52BD977 (profesor_id), INDEX IDX_DA9B0DFFCB305D73 (proveedor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
