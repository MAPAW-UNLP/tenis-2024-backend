 ...
 */
final class Version20241027233124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario CHANGE rol rol_por_defecto VARCHAR(30) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE usuario CHANGE rol_por_defecto rol VARCHAR(30) NOT NULL');
    }
}
