...
final class Version20241120192911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clases (id INT AUTO_INCREMENT NOT NULL, cliente_id INT DEFAULT NULL, profesor_id INT DEFAULT NULL, tipo VARCHAR(20) NOT NULL, importe INT NOT NULL, cancha_id INT NOT NULL, fecha DATE NOT NULL, hora_ini TIME NOT NULL, hora_fin TIME NOT NULL, INDEX IDX_67CBBF10DE734E51 (cliente_id), INDEX IDX_67CBBF10E52BD977 (profesor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cliente (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(30) NOT NULL, telefono VARCHAR(15) NOT NULL, fecha_nac DATE DEFAULT NULL, es_alumno TINYINT(1) NOT NULL, visible TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cobro (id INT AUTO_INCREMENT NOT NULL, cliente_id INT DEFAULT NULL, id_tipo_clase INT DEFAULT NULL, monto DOUBLE PRECISION NOT NULL, fecha DATE NOT NULL, hora TIME NOT NULL, concepto VARCHAR(255) NOT NULL, descripcion VARCHAR(100) DEFAULT NULL, INDEX IDX_F0A26526DE734E51 (cliente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cuenta (id INT AUTO_INCREMENT NOT NULL, cliente_id INT NOT NULL, importe INT NOT NULL, fecha DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE grupo (id INT AUTO_INCREMENT NOT NULL, reserva_id INT NOT NULL, cliente_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
